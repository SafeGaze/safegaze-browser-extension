...
// src/background/masking-pipeline/maskingPipeline.js
var maskingPipeline = class {
  constructor() {
  ...
  async loadModel() {
    this._model = await Se.BodyPix;
    this._segmenter = await ke(
      this._model,
      this._segmenterConfig
    );
  }
  ...
  async processImage(url, is_base64, n2, img) {
    if (is_base64 === true) {
      console.log("base64 image", n2);
      return url;
    }
